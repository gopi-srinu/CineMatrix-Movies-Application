...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonIcon, IonCardSubtitle, IonCardContent, IonCardHeader, IonCardTitle, IonCard } from '@ionic/angular/standalone';
...
@Component({
    ...
    templateUrl: './drama-series.page.html',
    styleUrls: ['./drama-series.page.scss'],
    standalone: true,
    imports: [IonCard, IonCardTitle, IonCardHeader, IonCardContent, IonCardSubtitle, IonIcon, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, SidenavComponent, NavbarComponent]
})
export class DramaSeriesPage implements OnInit {
